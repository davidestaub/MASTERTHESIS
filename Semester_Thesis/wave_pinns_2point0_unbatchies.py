...
wandb.init(project='test',name='50k uncutt')
...
torch.save(pinn.approximate_solution.state_dict(),
           "50k_variational_conditined_from_1to4_4layers_lambda_25nr2_epochs_4k_lr_05_full_batch_domain-1t01_unnormalized.pth")
