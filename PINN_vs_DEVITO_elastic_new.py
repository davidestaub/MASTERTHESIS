...
pth1 = 'PINN_mixture_thesis_100000_200_1.0_100_100_100_4_32_tanh_0.1_FCN_ALL_PARAMS_WAVELET_FCN_128_4_64_mixture_0.1'
pth2 = 'PINN_new_source2_100000_200_1.0_100_100_100_5_128_tanh_0.2_PINN_1_constant_0.1'
    ...
    for mu_quake_y in mu_quake_y_list:
        ...
        for test_model in ['Vanilla','PLANEWAVE']:
            ...
            if test_model == 'Vanilla':
                ...
                save_path = '../../Results/Elastic/mixture_thesis_test/[{}_{}]/Vanilla/'.format(str(mu_quake_x),str(mu_quake_y))
                os.makedirs(save_path, exist_ok=True)
                input_folder = pth2
            else:
                save_path = '../../Results/Elastic/mixture_thesis_test/[{}_{}]/WAVELET/'.format(str(mu_quake_x),str(mu_quake_y))
                os.makedirs(save_path, exist_ok=True)
                input_folder = pth1
