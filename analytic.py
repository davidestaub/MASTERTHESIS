...
def pinn_model_eval(input_tensor):
    ...
    #M#0_1 = torch.clamp(M0_1,min=0.0)
    ...
    return [[analytic_x,analytic_y,M_dot1,M_dot2,A_FP_x,A_FP_y,A_FS_x,A_FS_y,M0_dot_input1,M0_dot_input2,phi,r_hat_x,r_hat_y,phi_hat_x,phi_hat_y],["analytic_x","analytic_y","M0_dot1","M0_dot2","A_FP_x","A_FP_y","A_FS_x","A_FS_y","M0_dot_input1","M0_dot_input2","phi","r_hat_x","r_hat_y","phi_hat_x","phi_hat_y"]]

index = 0
for j in np.linspace(-0.97,-0.5,3).tolist():
    index = index +1
